...
private:
    ...
    std::vector<std::uint8_t> assignDensityToPixelBuffer(float density, int x, int y); // method that takes a density value and assigns it valid R, G, B, and A values to a return a tone of grey corresponding to the density
